...
export async function GET({ params }) {
  ...
  const getLocationData = fetch(`https://www.instagram.com/explore/locations/${locationID}/?__a=1&__d=dis`, {
    ...
    .then(data => {
      ...
      // console.log('successfully deconstructed data from get-location-data API \n ...deconstructing then formatting data');
      // format the top posts data retrieved from sections
